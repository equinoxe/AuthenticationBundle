 ...
 */
class UserTest extends \Equinoxe\FlexiflowBundle\Test\WebTestCase
{
    ...
    public function testRolePersistence()
    {
        ...
        $query = $em->createQuery("SELECT u FROM \Equinoxe\FlexiflowBundle\Entity\Security\User u WHERE u.uid = " . $this->object->getUid());
